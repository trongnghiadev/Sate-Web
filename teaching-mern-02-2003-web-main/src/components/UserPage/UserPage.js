            ...
            <div className="tab-inner-content mt-5 account">
              ...
              <div className="notice mt-5">
                ...
                <div className="notice__message">
                  <p>This is an awesome <a href="#" target="blank" style={{ 'textDecoration': 'none' }}>State Web</a> in the field of programming. This course teach everyone how to create a Trello web app clone.</p>
